"""Plot the classic neural-network activation functions side by side.

The functions themselves are importable (and unit tested); the plotting only
...
def plot_activations(x=None):
	"""Draw input / sigmoid / tanh / ReLU / leaky ReLU in one figure."""
	if x is None:
